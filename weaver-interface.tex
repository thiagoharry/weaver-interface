...
para armazenar a posição $x$ e duas para armazenar a posição $y$. Isso
ocorre porque quando a macro \monoespaco{W\_FORCE\_LANDSCAPE} está
definida e temos uma tela com mais altura e largura, assumimos que o
nosso eixo $x$ e $y$ estarão rotacionados. Nestes casos, as
variáveis \monoespaco{\_x} e \monoespaco{\_y} armazenarão os valores
verdadeiros, quando os eixos não estão trocados e as
variáveis \monoespaco{x} e \monoespaco{y} armazenarão as variáveis com
os eixos trocados. Nos outros casos, se a largura for maior que a
altura ou se a macro não estiver definida, ambos os tipos de variáveis
terão sempre o mesmo valor.
...
coordenadas de textura em sua versão normal e rotatcionada. Eles são
declarados abaixo:
...
static const float interface_vertices[28] = {
  ...
  0.0, 1.0,    // Coordenada de textura rotacionada
  1.0, 0.0, 0.0, // Segundo vértice
  1.0, 0.0,     // Textura
  0.0, 0.0,    // Textura rotacionada
  1.0, 1.0, 0.0,  // Terceiro vértice
  1.0, 1.0,      // Textura
  1.0, 0.0,     // Textura rotacionada 
  0.0, 1.0, 0.0, // Quarto vértice
  0.0, 1.0,     // Textura
  1.0, 1.0};   // Textura rotacionada 
