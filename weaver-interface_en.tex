...
Notice that in fact we have two variables to store position $xx$ and
...
$y$. In this case, the variables \monoespaco{\_x} and \monoespaco{\_y}
will store the real value, as if the axis were not swapped and the
variables \monoespaco{x} and \monoespaco{y} store the values with the
...
0)$. Each vertex have as argument the texture coordinate. They are
declared below:
